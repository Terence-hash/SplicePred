...
def extract_bgd_signals(whole_seq, target_signals, signal_ulen, signal_dlen, site_type, excluding=True):
    """
    提取背景信号
    """
    bgd_signals = []
...
def extract_signals(dir_path, donor_ulen, donor_dlen, acceptor_ulen, acceptor_dlen, excluding=True):
    ...
    for file_name in os.listdir(dir_path):
        ...
        with open(dir_path + file_name, 'r') as f:
            ...
            bd_signals.extend(extract_bgd_signals(whole_seq, donor_signals, donor_ulen,
                                                  donor_dlen, site_type="donor", excluding=True))
            ba_signals.extend(extract_bgd_signals(whole_seq, acceptor_signals, acceptor_ulen,
                                                  acceptor_dlen, site_type="acceptor", excluding=True))
...
if __name__ == '__main__':
    ...
    # 提取核苷酸序列信号
    donor_ulen, donor_dlen, acceptor_ulen, acceptor_dlen = 9, 9, 12, 5
